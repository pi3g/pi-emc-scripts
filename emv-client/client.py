...
FILEIO_DIRECTORY="/media/pi/T7/sysbench"
...
class Client:
    def __init__(self):
        ...
        if MODULE_LAN:
            ...
            self.iperf_lan.name = "IPerfClient LAN"
        ...
        if MODULE_WLAN:
            ...
            self.iperf_wlan.name = "IPerfClient WLAN"
        ...
        if MODULE_BLUETOOTH_AUDIO:
            ...
            self.bluetooth_audio.name = "Bluetooth Audio"
            self.modules.append(self.bluetooth_audio)

        sleep(5) # Wait a bit after bluetooth stuff
        
        if MODULE_AUDIO:
            self.headset_audio = Audio(HEADSET_SINK, HEADSET_FREQUENCY, HEADSET_VOLUME)
            self.headset_audio.name = "Headset Audio"
